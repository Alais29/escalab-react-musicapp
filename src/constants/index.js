...
const chart_tracks_get = 'chart_name=top&page=1&page_size=10&f_has_lyrics=1';
const track_search = 'track.search?q_track=';
const track_search_params = 'page_size=10&page=1&f_has_lyrics=1&s_track_rating=desc';
const track_lyrics_get = 'track.lyrics.get?commontrack_id=';
const track_get = 'track.get?commontrack_id=';
const api_key = '&apikey=478fab1e46092d8f75ee3d81da1671f4';
